...
var instance = new razorpay({
    key_id: process.env.RAZORPAY_API_KEY || "rzp_live_EiOXHjuoxVVY2U",
    key_secret: process.env.RAZORPAY_API_SECRET || "9Oqtn53sjkP25X0lsy9fhNWX",
});
...
const paymentVerification = async (req, res) => {
    try {
        ...
        const expectedSignature = crypto
            .createHmac("sha256", process.env.RAZORPAY_API_SECRET || "9Oqtn53sjkP25X0lsy9fhNWX")
            .update(body)
            .digest("hex");
